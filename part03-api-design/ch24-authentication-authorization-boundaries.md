...
**Nobody hacked anything. Nobody even lied, exactly.** Your friend used her own real, valid access to run an errand for you, and the system trusted her badge without ever asking whose errand this was.

If that room held something that mattered — other kids' private stuff, test materials, whatever — you just got it, because the door checked *who* could scan in, and never checked *what* the request was actually for, or *who* it was really for.
