...
**A lazy rule sounds like "the blue Uno card beats the red one."** Fast to write, and it works fine — right up until the Uno deck goes missing and you're stuck with a normal deck that doesn't even have blue cards.

Now half your rulebook doesn't mean anything, because the rule and the one deck you happened to own got welded together.
